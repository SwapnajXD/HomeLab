...
See the [infrastructure baseline](../docs/infrastructure.md) and [roadmap](../docs/roadmap.md). Future active Terraform modules belong here; state and credentials remain excluded from Git.
