...
The [September 12 rebuild history](rebuild-history.md) is the dated implementation and troubleshooting record. Its health results were supplied by the operator; this documentation update did not run live checks.
...
Earlier [runbooks](docs/historical/runbook.md), [health checks](docs/historical/health-checks.md), [troubleshooting](docs/historical/troubleshooting.md), [validation reports](docs/historical/validation-report.md) and [postmortems](docs/historical/postmortems.md) preserve history; use the V2 inventory and endpoints when planning future operations.
