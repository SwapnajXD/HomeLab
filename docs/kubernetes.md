...
**Implemented:** single-node K3s on Hermes VM 101, replacing Athena's old installation. The [September 12 rebuild record](history/rebuild-history.md) reports Ubuntu 24.04.5, 4 vCPU, 4 GiB RAM and a 32 GiB disk.
