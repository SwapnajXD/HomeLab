...
**Recorded baseline: 2026-09-12.** The [operator-supplied rebuild history](rebuild-history.md) supersedes the earlier migration plan. This is documentation of reported implementation, not a new live audit.
...
- [Full implementation and challenge history](rebuild-history.md)
...
- [Canonical roadmap](HOMELAB_ROADMAP.md), [retired services](docs/historical/retired-services.md)

Earlier documents in `docs/historical/` are historical references. Current configuration snapshots have not been synchronized from the hosts by this documentation change.
